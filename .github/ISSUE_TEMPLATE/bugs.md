...
- **Ensure the bug is reproducible and has not already been fixed** — use the [latest version](https://github.com/svengreb/tmpl/releases/latest) and [`main`](https://github.com/svengreb/tmpl/tree/main) branch.
...
Provide a [MCVE - The Minimal, Complete, and Verifiable Example](https://github.com/svengreb/tmpl/blob/main/CONTRIBUTING.md#mcve)
...
- What is the version of tmpl you are using?
